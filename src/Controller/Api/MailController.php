...
class MailController extends BaseController
{
    ...
    /**
     * @Route("/listing", name="api_email_listing", methods={"GET"}, options={"expose"=true})
     *
     * {mô tả api}
     *
     * @param Cache $cache
    ...
    /**
     * @Route("/show-email-log", name="api_email_show_email_log", methods={"GET"}, options={"expose"=true})
     *
     * {mô tả api}
     *
     * @param Cache $cache
