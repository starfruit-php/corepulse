...
{
    /**
     * @Route("/get-setting", name="api_plausible_get_setting", methods={"GET"}, options={"expose"=true})
     *
     * {mô tả api}
     *
     * @param Cache $cache
    ...
    /**
     * @Route("/setup", name="api_plausible_setup", methods={"GET"}, options={"expose"=true})
     *
     * {mô tả api}
     *
     * @param Cache $cache
    ...
    /**
     * @Route("/get-data", name="api_plausible_get_data", methods={"GET"}, options={"expose"=true})
     *
     * {mô tả api}
     *
     * @param Cache $cache
