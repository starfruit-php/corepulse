...
class UserController extends BaseController
{
    ...
    /**
     * @Route("/detail", name="api_user_detail", methods={"GET"}, options={"expose"=true})
     *
     * {mô tả api}
     *
     * @param Cache $cache
    ...
    /**
     * @Route("/profile", name="api_user_profile", methods={"GET"}, options={"expose"=true})
     *
     * {mô tả api}
     *
     * @param Cache $cache
    ...
    /**
     * @Route("/edit-profile", name="api_user_edit_profile", methods={"GET"}, options={"expose"=true})
     *
     * {mô tả api}
     *
     * @param Cache $cache
    ...
    /**
     * @Route("/edit-password", name="api_user_edit_password", methods={"GET"}, options={"expose"=true})
     *
     * {mô tả api}
     *
     * @param Cache $cache
